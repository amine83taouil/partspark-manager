...
export default function AdminPanel() {
  ...
  const handleUpdatePassword = async (profileId: string, newPassword: string) => {
    ...
    try {
      ...
      const { error } = await supabase.from("profiles").update({ password_hash: hashedPassword }).eq("id", profileId)
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>Créez un compte pour un nouvel opérateur ou administrateur</DialogDescription>
                </DialogHeader>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Select
                      value={formData.role}
                      onValueChange={(value) => setFormData({ ...formData, role: value as "admin" | "operator" })}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                  ...
                  <TableRow key={profile.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center space-x-2">
                        ...
                        >
                          {profile.is_active ? <UserX className="h-3 w-3" /> : <UserCheck className="h-3 w-3" />}
                        </Button>
                      </div>
                    </TableCell>
                  </TableRow>
