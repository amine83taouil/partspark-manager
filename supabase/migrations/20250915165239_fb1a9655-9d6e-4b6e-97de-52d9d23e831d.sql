...
-- Create policies for parts (allow all operations for now - you can restrict later with auth)
...
CREATE INDEX IF NOT EXISTS idx_activity_logs_part_id ON public.activity_logs(part_id);